  ...
  return (
    <div className="privacy-container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to UP2U, VR Colony Road No 2, Kurnool, Andhra
            Pradesh, 518003.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to UP2U AD FILMS, accessible from{" "}
            <a
              href="https://up2uadfilms.site/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://up2uadfilms.site/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p>By phone number: 9392894805</p>
        </li>
      </ul>
    </div>
  );
